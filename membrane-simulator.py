...
new_area = 2500 # m^2
new_perm = 0.0285 # O2 permeance
new_alpha = 6.3025 # Selectivity
...
new = membrane_stage(stage3["retentate_flow"], stage3["retentate_O2"], new_area, new_perm, new_alpha, 115)

stages = [stage1, stage2, stage3, new]
